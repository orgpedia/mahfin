...
import/websites/gr.maharashtra.gov.in/Finance:
	cd import/websites/gr.maharashtra.gov.in/ && ln -s $(GR_DIR)/Finance .
...
import: check_env import/websites/gr.maharashtra.gov.in/Finance .secrets/google.token 
	poetry run python import/src/build_documents.py import/websites/gr.maharashtra.gov.in/Finance import/documents
